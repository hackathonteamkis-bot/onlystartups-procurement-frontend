  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-20 p-4 sm:p-6">
      <div className="flex flex-col gap-4">
        <Link href={`/startup-hub/programs/${programId}`} className="text-xs font-black text-muted-foreground flex items-center gap-2 hover:text-[#1A1A2E] transition-colors tracking-widest uppercase w-fit">
