...
import { getStartupHubData, addStartup, removeStartup } from "@/actions/startup-hub";
                  ...
                  return (
                    <TableRow key={startup.id} className="border-[#1A1A2E]/5 group transition-colors hover:bg-[#F26522]/5">
                      <TableCell className="font-bold text-sm">
                        <Link href={`/startup-hub/portfolio/${startup.id}`} className="hover:text-[#F26522] hover:underline transition-colors">
                          ...
                          <DropdownMenuContent align="end">
                            {startup.applications?.[0]?.id ? (
                              <DropdownMenuItem asChild className="cursor-pointer">
                                <Link href={`/startup-hub/programs`} className="flex items-center gap-2 w-full">
