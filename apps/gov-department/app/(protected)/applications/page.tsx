...
export default function UserApplicationsPage() {
  ...
  const applications = data
    ? [
      ...(data.govDepartmentApplications || []).map((a: { id: string; govDepartmentId: string; status: string; createdAt: string; govDepartment: any }) => ({
        ...a,
        type: "GOV_DEPARTMENT" as const,
      })),
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col md:flex-row gap-6 md:items-center justify-between">
                      ...
                      <div className="min-w-0">
                        ...
                        {app.type === "GRANT" && (
                          <p className="text-[10px] font-bold text-muted-foreground mt-2 flex items-center gap-1">
                            ...
                            By {app.govDepartment.startupName || app.govDepartment.name}
                          </p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      <Link
                        href={`/explore/gov-departments/${app.govDepartmentId}`}
