    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <Link href={`/gov-department/programs/${program.id}/applications/${app.id}`} className="font-black text-base text-gray-900 group-hover:text-[#F26522] transition-colors line-clamp-1">
        ...
        <Link href={`/gov-department/programs/${program.id}/applications/${app.id}`} className="text-[10px] font-black uppercase tracking-widest text-[#1A1A2E] bg-gray-50 px-3 py-1.5 rounded-full hover:bg-[#F26522] hover:text-white transition-colors flex items-center gap-1">
...
export default function ProgramCommandCenter() {
  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-8 pb-20 p-4 sm:p-6 animate-in fade-in duration-500">
      <Link href="/gov-department/programs" className="text-xs font-black text-muted-foreground flex items-center gap-2 hover:text-[#1A1A2E] transition-colors tracking-widest uppercase w-fit bg-gray-50 px-4 py-2 rounded-full">
