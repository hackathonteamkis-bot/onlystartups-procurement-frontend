        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <p className="text-[#1A1A2E] font-medium text-sm">
            {filteredPrograms.length === initialPrograms.length 
              ? `Showing all ${initialPrograms.length} Problem Statements`
              : `Showing ${filteredPrograms.length} of ${initialPrograms.length} Problem Statements`}
          </p>
            ...
            <Sheet>
              ...
              <SheetContent className="w-[300px] sm:w-[400px] overflow-y-auto p-6">
                ...
                <div className="space-y-8">
                  ...
                  {/* Duration Filters */}
                  <div className="space-y-4">
                    <h3 className="font-bold text-sm text-[#1A1A2E] border-b border-muted/60 pb-2">Duration</h3>
                    <div className="space-y-3">
                      {durations.length > 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredPrograms.length > 0 ? (
            ...
            <div className="col-span-full flex flex-col items-center justify-center py-24 bg-white/50 rounded-2xl border border-dashed border-[#1A1A2E]/10">
              ...
              <p className="text-base font-bold text-[#1A1A2E]">No problem statements found</p>
