            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <Card className="border-none shadow-sm bg-white/60">
                    <CardContent className="p-5 flex items-center justify-between">
                        <div>
                            <p className="text-[10px] font-bold text-[#1A1A2E]/40 uppercase tracking-widest">Submitted Solutions</p>
                            <p className="text-2xl font-black text-[#1A1A2E] mt-1">12</p>
                        </div>
                ...
                <Card className="border-none shadow-sm bg-white/60">
                    <CardContent className="p-5 flex items-center justify-between">
                        <div>
                            <p className="text-[10px] font-bold text-[#1A1A2E]/40 uppercase tracking-widest">Active Pilots</p>
                            <p className="text-2xl font-black text-[#1A1A2E] mt-1">{stats?.matchCount || 3}</p>
                        </div>
                ...
                <Card className="border-none shadow-sm bg-white/60">
                    <CardContent className="p-5 flex items-center justify-between">
                        <div>
                            <p className="text-[10px] font-bold text-[#1A1A2E]/40 uppercase tracking-widest">Active Contracts</p>
                            <p className="text-2xl font-black text-[#1A1A2E] mt-1">{stats?.agreementCount || 2}</p>
                        </div>
                ...
                <Card className="border-none shadow-sm bg-[#1A1A2E] text-white">
                    <CardContent className="p-5 flex items-center justify-between">
                        <div>
                            <p className="text-[10px] font-bold text-white/60 uppercase tracking-widest">Milestones Met</p>
                ...
                <div className="lg:col-span-2 space-y-6">
                    <Card className="border-none shadow-xl bg-white/80 backdrop-blur-sm rounded-2xl w-full min-w-0 overflow-hidden">
                        <CardHeader className="px-5 pt-5 pb-2">
                            <div className="flex items-center justify-between">
                                <div>
                                    <CardTitle className="text-lg">Pilot Performance Overview</CardTitle>
                                    <CardDescription className="text-xs">Milestone completion & pilot engagement over time.</CardDescription>
                                </div>
                    ...
                    <Card className="border-none shadow-sm bg-white/60 rounded-2xl">
                        <CardHeader className="px-5 pt-5 pb-3">
                            <CardTitle className="text-sm">Procurement Checklist</CardTitle>
                        </CardHeader>
                        <CardContent className="px-5 pb-5">
