    ...
    const groups: NavGroup[] = [
      {
        ...
        items: [
          ...
          { name: "Updates", href: "/os-daily", icon: Newspaper },
          { name: "Support", href: "/fix-this", icon: Zap },
        ],
      },
    ];
    ...
    if (userRole === "GOV_DEPARTMENT") {
      groups.push({
        ...
        items: [
          ...
          {
            name: "Briefings & Workshops",
            href: "/gov-department/events",
            icon: Calendar,
          },
        ],
      });
      ...
      items: [
        {
          ...
          items: [
            ...
            { name: "SMS Campaigns", href: "/marketing/sms" },
            { name: "WhatsApp Campaigns", href: "/marketing/whatsapp" },
          ]
        },
      ...
      items: [
        {
          ...
          items: [
            ...
            { name: "Organization Profile", href: "/profile/hub" },
          ],
        },
