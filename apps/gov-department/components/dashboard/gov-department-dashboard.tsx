...
export function GovDepartmentDashboard({ initialData }: { initialData?: any }) {
  ...
  const summaryStats = [
    { label: "Active Problem Statements", value: "12", icon: Users, trend: "+2 this month" },
    { label: "Active Pilots", value: "45", icon: TrendingUp, trend: "+8 this quarter" },
    { label: "Pending Evaluations", value: "28", icon: Target, trend: "Requires review", alert: true },
    { label: "New Solutions Submitted", value: "114", icon: FileCheck, trend: "+15 this week", alert: true },
  ];
    ...
    <div className="space-y-4 animate-in fade-in duration-500 pb-12 w-full px-1 sm:px-2">
      ...
      <div className="flex items-center gap-2 sm:gap-4 border-b border-slate-200/50 overflow-x-auto hide-scrollbar pb-px -mx-1 px-1 sm:mx-0 sm:px-0">
        {[
          ...
          { id: "health", label: "Pilot Performance" },
          { id: "demographics", label: "Startup Demographics" },
        ].map((tab) => (
          <button
            key={tab.id}
      ...
      <div className="pt-2">
        ...
        {activeTab === "pipeline" && (
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <AnalyticsSummary govDepartmentId={session?.user?.id || ""} className={GLASS_CARD} />
          </div>
        )}
          ...
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="grid gap-4 lg:grid-cols-3">
              <div className="lg:col-span-2 space-y-4 min-w-0">
                <Card className={cn(GLASS_CARD, "overflow-hidden")}>
                  <CardHeader className="border-b border-slate-100 pb-3 pt-4 px-4 sm:px-5">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      <CardTitle className="text-sm font-bold text-slate-900 truncate">Total Procurement Spend</CardTitle>
                ...
                <Card className={cn(GLASS_CARD, "overflow-hidden")}>
                  <CardHeader className="border-b border-slate-100 pb-3 pt-4 px-4 sm:px-5">
                    <CardTitle className="text-sm font-bold text-slate-900">Top Expert Evaluators</CardTitle>
                  </CardHeader>
              ...
              <div className="lg:col-span-1 space-y-4">
                <Card className="border-none shadow-xl bg-white/60 backdrop-blur-md rounded-2xl flex flex-col h-[320px] lg:h-auto lg:min-h-[300px]">
                  <CardHeader className="border-b border-rose-200/50 pb-3 pt-4 px-4 sm:px-5 bg-rose-50/30 rounded-t-2xl">
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-sm font-bold text-rose-900">Pilots at Risk</CardTitle>
          ...
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="grid gap-4 grid-cols-1 lg:grid-cols-2 items-start">
              <div className="flex flex-col gap-4">
                <Card className={GLASS_CARD}>
                  <CardHeader className="border-b border-slate-100 pb-3 pt-4 px-4 sm:px-5">
                    <CardTitle className="text-sm font-bold text-slate-900">Solution Category Breakdown</CardTitle>
                  </CardHeader>
                  <CardContent className="pt-4 px-4 sm:px-5 pb-5 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex-1 w-full flex items-center justify-center min-h-[220px]">
