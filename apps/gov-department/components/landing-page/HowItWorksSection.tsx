...
const steps = [
  ...
  },
  {
    ...
    description:
      "Connect with vetted legal professionals and resources to understand and navigate founder agreements, equity, and IP protections.",
    comingSoon: true,
  },
  {
    number: "05",
    ...
    description:
      "A real-time equity management tool to simulate dilution and maintain investment-ready ownership records.",
    comingSoon: true,
  },
  {
    number: "06",
