...
import { getHubEvents, deleteEvent } from "@/actions/startup-hub/events";
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-gray-900">Events Management</h1>
          <p className="text-sm text-gray-500">Create and manage upcoming events for your startup hub.</p>
        </div>
        <Link href="/startup-hub/events/new">
      ...
      {loading ? (
        ...
        <div className="p-12 text-center bg-white rounded-xl border border-dashed border-gray-200">
          ...
          <p className="text-gray-500 mb-6">Create your first event to start engaging with startups!</p>
          <Link href="/startup-hub/events/new">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end" className="w-40 bg-white border border-gray-100 rounded-lg shadow-lg py-1">
                            <DropdownMenuItem asChild className="cursor-pointer">
                              <Link href={`/startup-hub/events/${event.id}`} className="w-full flex items-center gap-2">
