  ...
  if ("error" in data || !data) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
        ...
        <h2 className="text-2xl font-bold text-black dark:text-white">HubSpot Unavailable</h2>
        <p className="text-muted-foreground max-w-md">{data?.message || data?.error || 'You must be assigned to a Startup Hub to access HubSpot.'}</p>
        <Link href="/explore">
