  ...
  if (!res || "error" in res) {
    return (
      <div className="h-[80vh] flex flex-col items-center justify-center gap-4 text-center">
        ...
        <h2 className="text-xl font-bold">Problem Statement not found</h2>
        <Link
      ...
      <div className="flex flex-col md:flex-row gap-8 lg:gap-12 mt-2 md:mt-6">
        ...
        <div className="order-1 md:order-2 md:w-7/12 lg:w-8/12 xl:w-9/12 space-y-8 md:pt-2">
          ...
          <div className="flex flex-col xl:flex-row gap-5 xl:gap-12 text-sm font-medium text-[#1A1A2E]">
             <div className="flex items-start gap-3">
               ...
               <div className="flex flex-col">
                 ...
                 <span className="text-muted-foreground text-[10px] uppercase tracking-widest mt-1">Timeline</span>
               </div>
             </div>
             <div className="flex items-start gap-3">
             ...
             <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    {program.status === 'INTAKE' ? `Deadline to apply: ${formatDate(program.applicationDeadline)}` : 'This problem statement is no longer taking new submissions.'}
                  </p>
                </div>
          ...
          <section className="space-y-4 pt-6">
            <h3 className="text-xs font-bold uppercase tracking-widest text-muted-foreground">About the Problem Statement</h3>
