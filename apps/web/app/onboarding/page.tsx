    ...
    list.push(
      {
        ...
        description: "Your professional role or title in your current venture.",
        type: "TEXT",
        placeholder: "e.g., Founder & CEO, Engineer, Product Lead",
        errorMessage: "Professional title must be at least 2 characters",
      },
      {
        id: "yearsOfExperience",
        label: "How long have you been active?",
        description: "Your professional years of experience in your field.",
        type: "SELECT_CHOICE",
        options: [
      ...
      },
      {
        id: "startupPhase",
        label: "Venture Stage",
        description: "Tell us about the current stage of your venture.",
        type: "SELECT_CHOICE",
        options: [
          { value: "Ideation", label: "Ideation / Pre-Seed" },
          { value: "MVP", label: "MVP / Building" },
          { value: "Early Traction", label: "Early Traction / Seed" },
          { value: "Growth", label: "Growth / Scaling" },
          { value: "none", label: "Not working on a startup yet" },
        ],
        errorMessage: "Please select your stage",
      }
    );
    ...
    if (formData.startupPhase && formData.startupPhase !== "none") {
      list.push(
        ...
        },
        {
          ...
          type: "TEXTAREA",
          placeholder: "e.g., We are building a next-gen collaborative developer tool...",
        ...
        <div className="relative z-10 min-h-[100dvh] flex flex-col items-center justify-center px-4 md:px-8 max-w-2xl w-full mx-auto">
          ...
          >
            ...
            <p className="text-sm sm:text-base text-[#1A1A2E]/50 font-medium max-w-md mx-auto leading-relaxed">
              Your profile is all set. We&apos;re taking you to the explore page.
            </p>
          </motion.div>
