            ...
            <div className="grid gap-6 lg:grid-cols-3 w-full min-w-0">
                ...
                <Card className="col-span-1 py-4 sm:py-6 gap-4 sm:gap-6 border-[#1A1A2E]/5 bg-white/40 rounded-2xl w-full min-w-0 overflow-hidden">
                    <CardHeader className="px-4 sm:px-6">
                        ...
                        <CardDescription>
                            Things you can do to get the most out of OnlyStartups.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="px-4 sm:px-6">
                            ...
                            {missingFields.length > 0 ? (
                                missingFields.slice(0, 3).map((field, index) => (
                                    <a
                                        key={index}
                                        href="/profile"
                                        className="flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 rounded-xl bg-white/50 hover:bg-white transition-all group cursor-pointer border border-transparent hover:border-[#F26522]/20"
                                    >
                                        <div className="h-10 w-10 rounded-full bg-[#F26522]/10 flex items-center justify-center group-hover:bg-[#F26522]/20 transition-colors shrink-0">
                                            <ArrowUpRight className="h-5 w-5 text-[#F26522]" />
                                        </div>
