...
interface IssueDetailContentProps {
  initialIssue: Issue;
  initialRecommendations: Issue[];
}

export function IssueDetailContent({ initialIssue, initialRecommendations }: IssueDetailContentProps) {
  ...
  const [recommendations, setRecommendations] = useState<Issue[]>(initialRecommendations || []);
    ...
    <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6 px-0 sm:px-4">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          <div className="relative w-9 h-9 rounded-full overflow-hidden bg-[#1A1A2E]/5 flex items-center justify-center border border-[#1A1A2E]/10">
            {issue.user.image ? (
                ...
                <div key={comment.id} className="space-y-4">
                  ...
                  <div className="flex gap-3 relative group/comment">
                    ...
                    <div className="flex flex-col items-center shrink-0">
                      <div className="relative w-7 h-7 rounded-full overflow-hidden bg-[#1A1A2E]/5 flex items-center justify-center border border-[#1A1A2E]/10">
                        {comment.user.image ? (
                    ...
                    <div className="ml-4 sm:ml-10 pl-3 sm:pl-4 border-l border-[#1A1A2E]/10 space-y-4">
                      {commentReplies.map((reply) => (
                        <div key={reply.id} className="flex gap-2.5 relative">
                          ...
                          <div className="flex flex-col items-center shrink-0">
                            <div className="relative w-6 h-6 rounded-full overflow-hidden bg-[#1A1A2E]/5 flex items-center justify-center border border-[#1A1A2E]/10">
                              {reply.user.image ? (
